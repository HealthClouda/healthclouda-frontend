...
| @Qeeyat | **D4 Receptionist** (Wed 19 row) — check-ins, appointments, registration, portal invite + the **FLAG-213 receptionist half** | `feat/dash-4-receptionist` | `receptionist/*`, `types/dashboard.ts`, `lib/config.ts` | 2026-08-24 | 🔄 open. ⚠️ **Absorbing E2's data layer inline** (`[INFRA]`, @Bastoh's lane, never landed) — claiming loudly. HCL-ID handout is **blocked on backend #137** |
